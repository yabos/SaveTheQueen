...
[CustomPropertyDrawer(typeof(ConditionalHideInspectorAttribute))]
public class ConditionalHideInspectorDrawer : PropertyDrawer
{
    ...
    private bool GetConditionalHideAttributeResult(ConditionalHideInspectorAttribute chiAttribute, SerializedProperty property)
    {
        ...
        if (chiAttribute.Inverse) enabled = !enabled;
