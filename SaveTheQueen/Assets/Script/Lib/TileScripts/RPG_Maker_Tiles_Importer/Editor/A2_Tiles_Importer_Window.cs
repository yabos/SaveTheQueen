...
public class A2_Tiles_Importer_Window : EditorWindow
{
    ...
    /// </summary>
    List<Texture2D> sub_blocks;

    /// <summary>
    /// List of boolean to select the block to import
    /// </summary>
    List<bool> sub_blocks_to_import;
    ...
    [MenuItem("Tools/RPGM Importer/Import A2 Tiles")]
    public static void ShowWindow()
    {
        EditorWindow.GetWindow<A2_Tiles_Importer_Window>(false, "A2 Tiles");
    }
