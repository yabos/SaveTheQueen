...
public class Tiles_Utility {
    ...
    /// </summary>
    public static string final_image_folder_path = @"Assets/RPG_Maker_Tiles_Importer/rtp_import";

    /// <summary>
    /// Path where the script will save the generated Auto Tile
    /// </summary>
    public static string Auto_Tile_Folder_Path = @"Assets/RPG_Maker_Tiles_Importer/rtp_auto_tiles";
