    ...
    public class TreeViewInspector : Editor
    {
        ...
        public static void AssignDefaults(GameObject go)
        {
            ...
            foreach (TreeViewControl item in items)
            {
                ...
                item.m_textureBlank = GetTexture(GetGizemoPath("blank.png"));
                item.m_textureGuide = GetTexture(GetGizemoPath("guide.png"));
                item.m_textureLastSiblingCollapsed = GetTexture(GetGizemoPath("last_sibling_collapsed.png"));
                item.m_textureLastSiblingExpanded = GetTexture(GetGizemoPath("last_sibling_expanded.png"));
                item.m_textureLastSiblingNoChild = GetTexture(GetGizemoPath("last_sibling_nochild.png"));
                item.m_textureMiddleSiblingCollapsed = GetTexture(GetGizemoPath("middle_sibling_collapsed.png"));
                item.m_textureMiddleSiblingExpanded = GetTexture(GetGizemoPath("middle_sibling_expanded.png"));
                item.m_textureMiddleSiblingNoChild = GetTexture(GetGizemoPath("middle_sibling_nochild.png"));
                item.m_textureNormalChecked = GetTexture(GetGizemoPath("normal_checked.png"));
                item.m_textureNormalUnchecked = GetTexture(GetGizemoPath("normal_unchecked.png"));
                item.m_textureSelectedBackground = GetTexture(GetGizemoPath("selected_background_color.png"));
                item.m_skinHover = skinHover;
                item.m_skinSelected = skinSelected;
                item.m_skinUnselected = skinUnselected;
        ...
        private static string GetGizemoPath(string fileName)
        {
            string gizmoPath = "Assets/ThirdParty/TAGENIGMA.TreeView/Gizmo/";
